...
def session_LS_make(reviews,cpu_num, session_LS_data_file,sequence_data_file, max_session_length,max_sess_num, user_vocab_file,item_vocab_file,cate_vocab_file ,session_interval ,valid_negtive_sample,test_negtive_sample,sample_probability ):
...
max_sess_num = 5
session_LS_data_file =  os.path.join(reviews_path,   "session_LS",session_interval+'_noise' )
os.makedirs(session_LS_data_file, mode = 0o777, exist_ok = True) 
 
sequence_data_file =  os.path.join(reviews_path,   "sequence"+'_noise' )
...
#制作session_LS_file
session_LS_make(session_reviews,cpu_num, session_LS_data_file,sequence_data_file, max_session_length,max_sess_num, user_vocab_file,item_vocab_file,cate_vocab_file ,session_interval,valid_negtive_sample,test_negtive_sample ,sample_probability)
