...
class DDSINModel_RLE(SequentialBaseModel):
    ...
    def _build_train_opt(self):
        ...
        return super(DDSINModel_RLE, self)._build_train_opt()
        ...
        with tf.variable_scope("ddsin"):
                ...
                with tf.variable_scope("long_term"):
                   ...
                   # long_query_emb = tf.reduce_mean(sequence_pre_input, 1) 
                    ...
                    self.att_fea_long=tf.concat([self.att_fea_long_sasrec, self.att_fea_long_sasrec ],1)
