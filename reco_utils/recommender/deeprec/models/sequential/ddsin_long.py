...
class DDSINModel_long(SequentialBaseModel):
    ...
    def _build_train_opt(self):
        ...
        return super(DDSINModel_long, self)._build_train_opt()
...
#######################################################################
    ...
    def _build_seq_graph(self):
        ...
        with tf.variable_scope("ddsin"):
                ...
                user_LS_embed   =self.att_fea_long 
    ...
    def batch_train(self, file_iterator, train_sess, valid_file,valid_num_ngs ,epoch,eval_metric):
        ...
        for batch_data_input in file_iterator:
            if batch_data_input:
                ...
                (_, _, step_loss, step_forward_data_loss,    step_regular_loss,    summary) = step_result
               ...
               # epoch_contrastive_loss +=step_contrastive_loss
                ...
                if step % self.hparams.show_step == 0:
                    print(
                        "step {0:d} , total_loss: {1:.4f}, forward_data_loss: {2:.4f}    ".format(
                            step, step_loss, step_forward_data_loss 
                        )
                    )
    ...
    def run_weighted_eval_write(self, infile_name, outfile_name,num_ngs,calc_mean_alpha=False ):
