...
class DDSINModel_RC(SequentialBaseModel):
    ...
    def _build_train_opt(self):
        ...
        return super(DDSINModel_RC, self)._build_train_opt()
        ...
        with tf.variable_scope("ddsin"):
                ...
                with tf.variable_scope("short_term"):
                   ...
                   # short_query_emb =   tf.concat([short_term_intention , self.target_item_embedding], -1)
                    ...
                    self.att_fea_short  = tf.concat([self.att_fea_short_rnn,self.att_fea_short_rnn],1)
