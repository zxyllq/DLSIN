...
from reco_utils.recommender.deeprec.models.sequential.ddsin import DDSINModel
from reco_utils.recommender.deeprec.models.sequential.ddsin_r_L import DDSINModel_r_L
from reco_utils.recommender.deeprec.models.sequential.ddsin_rl import DDSINModel_RL

from reco_utils.recommender.deeprec.models.sequential.ddsin_rs import DDSINModel_RS
from reco_utils.recommender.deeprec.models.sequential.ddsin_rc import DDSINModel_RC
from reco_utils.recommender.deeprec.models.sequential.ddsin_rle import DDSINModel_RLE
from reco_utils.recommender.deeprec.models.sequential.fmlp import FMLPModel
 
from reco_utils.recommender.deeprec.models.sequential.ddsin_short import DDSINModel_short
from reco_utils.recommender.deeprec.models.sequential.ddsin_long import DDSINModel_long

from reco_utils.recommender.deeprec.models.sequential.fearec import FEARecModel

import pdb 
 

from reco_utils.recommender.deeprec.io.sequence_aug_iterator import SequenceAugIterator  
from reco_utils.recommender.deeprec.io.sequence_w_succ_iterator import AllSessionSuccLSIterator 

from reco_utils.recommender.deeprec.io.sequence_session_w_succ_iterator import (SequenceSessionSuccExLSIterator,SequenceSessionSuccLSIterator,
                                                                                SequenceSessionMaskLSIterator,SequenceSessionCropLSIterator,
                                                                                SequenceSessionReorderLSIterator,
                                                                                 SequenceSessionSuccExwMaskLSIterator,SequenceSessionSuccExwCropLSIterator,SequenceSessionSuccExwReorderLSIterator )
FLAGS = flags.FLAGS
...
flags.DEFINE_string('name', 'taobao-ddsin-debug', 'Experiment name.')
flags.DEFINE_string('model', 'DDSIN', 'Model name.')
...
def get_model(flags_obj, model_path, summary_path, user_vocab, item_vocab, cate_vocab, train_num_ngs):
    ...
    max_seq_length = 10
    time_unit = 's'
    if flags_obj.model in[ "DDSIN","DDSIN_r_L","FMLP","DDSIN_short","DDSIN_long","DDSIN_RS","DDSIN_RC","DDSIN_RLE"]   : 
        input_creator =    SequenceSessionSuccExLSIterator
    elif flags_obj.model in[ "DDSIN_RL" ]   : 
        input_creator =    AllSessionSuccLSIterator
    
    elif flags_obj.model in['DDSIN_mask','DDSIN_short_mask' ]:
        input_creator = SequenceSessionMaskLSIterator
    elif flags_obj.model in ["DDSIN_crop","DDSIN_short_crop"]:
        input_creator =SequenceSessionCropLSIterator
    elif flags_obj.model in ["DDSIN_reorder","DDSIN_short_reorder"]:
        input_creator =SequenceSessionReorderLSIterator
    elif flags_obj.model in['DDSIN_ExWmask','DDSIN_short_ExWmask' ]:
        input_creator = SequenceSessionSuccExwMaskLSIterator
    elif flags_obj.model in ["DDSIN_ExWcrop","DDSIN_short_ExWcrop"]:
        input_creator = SequenceSessionSuccExwCropLSIterator
    elif flags_obj.model in ["DDSIN_ExWreorder","DDSIN_short_ExWreorder"]:
        input_creator = SequenceSessionSuccExwReorderLSIterator
    elif flags_obj.model in ["FEARec"]:
        input_creator = SequenceAugIterator
    ...
    if flags_obj.model in['DDSIN','DDSIN_mask',"DDSIN_crop","DDSIN_reorder",'DDSIN_ExWmask',"DDSIN_ExWcrop","DDSIN_ExWreorder"] :
        yaml_file = '../../reco_utils/recommender/deeprec/config/ddsin.yaml'
        ...
        model = DDSINModel(hparams,  input_creator,  seed=RANDOM_SEED)
    elif flags_obj.model in['DDSIN_r_L' ] :
        yaml_file = '../../reco_utils/recommender/deeprec/config/ddsin.yaml'
        hparams = prepare_hparams(yaml_file, 
                                embed_l2=flags_obj.embed_l2, 
                                layer_l2=flags_obj.layer_l2, 
        ...
        model = DDSINModel_r_L(hparams,  input_creator,  seed=RANDOM_SEED)

    elif flags_obj.model in['DDSIN_RS' ] :
        yaml_file = '../../reco_utils/recommender/deeprec/config/ddsin.yaml'
        hparams = prepare_hparams(yaml_file, 
                                embed_l2=flags_obj.embed_l2, 
                                layer_l2=flags_obj.layer_l2, 
        ...
        model = DDSINModel_RS(hparams,  input_creator,  seed=RANDOM_SEED)
    elif flags_obj.model in['DDSIN_RC' ] :
        yaml_file = '../../reco_utils/recommender/deeprec/config/ddsin.yaml'
        hparams = prepare_hparams(yaml_file, 
                                embed_l2=flags_obj.embed_l2, 
                                layer_l2=flags_obj.layer_l2, 
        ...
        model = DDSINModel_RC(hparams,  input_creator,  seed=RANDOM_SEED)
    elif flags_obj.model in['DDSIN_RLE' ] :
        yaml_file = '../../reco_utils/recommender/deeprec/config/ddsin.yaml'
        hparams = prepare_hparams(yaml_file, 
                                embed_l2=flags_obj.embed_l2, 
                                layer_l2=flags_obj.layer_l2, 
        ...
        model = DDSINModel_RLE(hparams,  input_creator,  seed=RANDOM_SEED)
    elif flags_obj.model in['DDSIN_RL' ] :
        yaml_file = '../../reco_utils/recommender/deeprec/config/ddsin.yaml'
        hparams = prepare_hparams(yaml_file, 
                                embed_l2=flags_obj.embed_l2, 
        ...
        model = DDSINModel_RL(hparams,  input_creator,  seed=RANDOM_SEED)
    elif flags_obj.model in[ 'DDSIN_short','DDSIN_short_mask',"DDSIN_short_crop","DDSIN_short_reorder",'DDSIN_short_ExWmask',"DDSIN_short_ExWcrop","DDSIN_short_ExWreorder"] :
        yaml_file = '../../reco_utils/recommender/deeprec/config/ddsin_short.yaml'
        hparams = prepare_hparams(yaml_file, 
                                embed_l2=flags_obj.embed_l2, 
                                layer_l2=flags_obj.layer_l2, 
                               # forget_lambda =flags_obj.forget_lambda,
        ...
        model = DDSINModel_short(hparams,  input_creator,  seed=RANDOM_SEED)
    elif flags_obj.model == 'DDSIN_long':
        yaml_file = '../../reco_utils/recommender/deeprec/config/ddsin_long.yaml'
        hparams = prepare_hparams(yaml_file, 
                                embed_l2=flags_obj.embed_l2, 
                                layer_l2=flags_obj.layer_l2, 
                                start_forget_lambda =flags_obj.start_forget_lambda,
                                end_forget_lambda =flags_obj.end_forget_lambda,
                                alpha_margin=flags_obj.alpha_margin,
                                start_topN =flags_obj.start_topN ,
                                end_topN= flags_obj.end_topN,
                                start_iteration= flags_obj.start_iteration,
                                ...
                                max_session_count=flags_obj.max_session_count,
                                valid_step =flags_obj.valid_step,
                               # layer_sizes =flags_obj.layer_sizes,
        ...
        model = DDSINModel_long(hparams,  input_creator,  seed=RANDOM_SEED)
    elif flags_obj.model in ['FMLP' ] :
        yaml_file = '../../reco_utils/recommender/deeprec/config/fmlp.yaml'
        hparams = prepare_hparams(yaml_file, 
                                embed_l2=flags_obj.embed_l2, 
                                layer_l2=flags_obj.layer_l2, 
                               # forget_lambda =flags_obj.forget_lambda,
        ...
        model = FMLPModel(hparams,  input_creator,  seed=RANDOM_SEED) 
    elif flags_obj.model in ['FEARec' ] :
        yaml_file = '../../reco_utils/recommender/deeprec/config/fearec.yaml'
        hparams = prepare_hparams(yaml_file, 
                                embed_l2=flags_obj.embed_l2, 
                                layer_l2=flags_obj.layer_l2, 
                               # forget_lambda =flags_obj.forget_lambda,
        ...
        model = FEARecModel(hparams,  input_creator,  seed=RANDOM_SEED) 
